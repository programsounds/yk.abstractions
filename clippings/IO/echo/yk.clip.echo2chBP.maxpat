...
,
		"classnamespace" : "box",
		"rect" : [ -493.0, -1353.0, 2136.0, 1319.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "yk.echo2chBP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -5.813638489940644, -6.692505509132388 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 15.0, 13.0, 162.499998450279236, 169.196426957845688 ],
					"varname" : "yk.echo2chBP",
					"viewvisibility" : 1
				}
		...
		"dependency_cache" : [ 			{
				"name" : "yk.echo2chBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/IO/echo",
				"patcherrelativepath" : "../../../patchers/IO/echo",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.poly.echo2ch.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/IO/echo/lib",
				"patcherrelativepath" : "../../../patchers/IO/echo/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Utillities/vdelay",
				"patcherrelativepath" : "../../../patchers/Utillities/vdelay",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
