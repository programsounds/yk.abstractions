...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 6,
					"offset" : [ -12.139534592628479, -9.488371968269348 ],
					"outlettype" : [ "signal", "float", "float", "", "", "" ],
					"patching_rect" : [ 13.953487873077393, 9.302325248718262, 176.162784397602081, 311.046500504016876 ],
		...
		"dependency_cache" : [ 			{
				"name" : "yk.envelopeFollowerBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Sensors/envelopeFollower",
				"patcherrelativepath" : "../../../patchers/Sensors/envelopeFollower",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/envelopeFollower/lib",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
