...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 3,
					"offset" : [ -10.959954084033967, -10.811700426704407 ],
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 7.0, 8.0, 177.005342423915863, 228.342239320278168 ],
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/spectralSpread/lib",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/spectralSpread",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
