...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 3,
					"offset" : [ -7.386789352769853, -4.637660764820099 ],
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 7.0, 8.0, 177.685940563678741, 229.338830262422562 ],
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/spectralDecrease/lib",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/spectralDecrease",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
