...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 4,
					"offset" : [ -8.291310714466094, -7.84947683683777 ],
					"outlettype" : [ "", "float", "", "" ],
					"patching_rect" : [ 14.110430061817169, 12.269939184188843, 168.711663782596588, 263.80369246006012 ],
...
, 			{
				"name" : "yk.onsetDetectorBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Sensors/onsetDetector",
				"patcherrelativepath" : "../../../patchers/Sensors/onsetDetector",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/onsetDetector/lib",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
