...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "yk.attackDetectorBP.maxpat",
					"numinlets" : 2,
					"numoutlets" : 3,
					"offset" : [ -12.999999940395355, -9.599999964237213 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 14.838709235191345, 14.838709235191345, 184.516123533248901, 201.93547785282135 ],
					"varname" : "yk.attackDetectorBP",
					"viewvisibility" : 1
				}
		...
		"dependency_cache" : [ 			{
				"name" : "yk.attackDetectorBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Sensors/attackDetector",
				"patcherrelativepath" : "../../../patchers/Sensors/attackDetector",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Sensors/attackDetector/lib",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
