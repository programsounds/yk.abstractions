...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -12.565711296783448, -10.495008316154479 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 12.060301780700684, 14.572864651679993, 235.678397297859192, 355.778902530670166 ],
					"varname" : "yk.delayBP",
					"viewvisibility" : 1
				}
...
, 			{
				...
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Effects/delay/1-2ch/lib",
				"patcherrelativepath" : "../../../patchers/Effects/delay/1-2ch/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.delay2chBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Effects/delay/1-2ch",
				"patcherrelativepath" : "../../../patchers/Effects/delay/1-2ch",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
