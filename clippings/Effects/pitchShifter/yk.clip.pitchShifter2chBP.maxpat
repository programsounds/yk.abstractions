...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "yk.pitchShifter2chBP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -3.97807802320099, -2.843778618560791 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 7.0, 5.0, 221.348332285881042, 236.516872823238373 ],
					"varname" : "yk.pitchShifter2chBP",
					"viewvisibility" : 1
				}
...
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Effects/pitchShifter/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "yk.pitchShifter2chBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Effects/pitchShifter",
				"patcherrelativepath" : "../../../patchers/Effects/pitchShifter",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
