...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ -12.02185845375061, -10.928962230682373 ],
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 14.0, 9.0, 574.316965222358704, 365.573786616325378 ],
					"varname" : "yk.EQ8BBP",
					"viewvisibility" : 1
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "yk.EQ8BBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Effects/EQ/8Bands",
				"patcherrelativepath" : "../../../patchers/Effects/EQ/8Bands",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Effects/EQ/8Bands/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
