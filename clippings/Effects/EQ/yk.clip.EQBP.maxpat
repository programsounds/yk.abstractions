...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ -15.546963393688202, -12.364642262458801 ],
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 11.602211058139801, 11.049724817276001, 251.381239593029022, 351.381249189376831 ],
					"varname" : "yk.EQBP",
					"viewvisibility" : 1
				}
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../patchers/Effects/EQ/1-2ch",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Effects/EQ/1-2ch/lib",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
