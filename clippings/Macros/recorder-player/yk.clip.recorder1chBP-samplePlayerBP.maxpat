...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 205.666672, 191.0, 38.0, 18.0 ],
					"text" : "del 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.666672, 214.0, 78.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 205.666672, 166.0, 32.5, 18.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 205.666672, 145.0, 38.0, 18.0 ],
					"text" : "del 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.666656, 145.0, 72.0, 18.0 ],
					"text" : "s 1_splayPlay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 205.666672, 120.0, 32.5, 18.0 ],
					"text" : "t b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 294.333344, 214.0, 79.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.333344, 191.0, 118.0, 16.0 ],
					"text" : "duplicate 1_recorder1ch"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "yk.recorder1chBP.maxpat",
					"numinlets" : 2,
					"numoutlets" : 4,
					"offset" : [ -11.0, -25.0 ],
					"outlettype" : [ "float", "bang", "", "" ],
					"patching_rect" : [ 11.0, 12.0, 311.0, 101.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 11.0, 242.0, 492.0, 188.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 228.666672, 187.5, 303.833344, 187.5 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 228.666672, 140.0, 257.166656, 140.0 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-3::obj-30" : [ "live.gain~", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.poly.recorder1ch.maxpat",
...
, 			{
				"name" : "yk.gen.recorder1ch.gendsp",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/IO/recorder/1ch/lib",
				"patcherrelativepath" : "../../../../../../../Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/IO/recorder/1ch/lib",
				"type" : "gDSP",
				"implicit" : 1
