...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ -14.362921121385575, -14.795369414257049 ],
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 12.0, 12.0, 213.852826535701752, 207.359319657087326 ],
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Players/samplePlayerPoly/1ch/lib",
				"patcherrelativepath" : "../../../patchers/Players/samplePlayerPoly/1ch/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "yk.samplePlayerPolyBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Players/samplePlayerPoly/1ch",
				"patcherrelativepath" : "../../../patchers/Players/samplePlayerPoly/1ch",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
