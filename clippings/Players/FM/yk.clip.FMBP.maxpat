...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 3,
					"offset" : [ -13.340425372123718, -13.212766170501709 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 11.0, 9.0, 213.61702573299408, 289.361708164215088 ],
					"varname" : "yk.FMBP",
					"viewvisibility" : 1
				}
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../patchers/Utillities/_legacy/>=p",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.FMBP.maxpat",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/Players/FM/2ch",
				"patcherrelativepath" : "../../../patchers/Players/FM/2ch",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Utillities/morphingWave",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../patchers/Players/FM/2ch/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
