...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 28.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "yk.harmonizer2BP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -20.0, -6.0 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 46.0, 241.0, 185.0, 256.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -7.0, -1.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 241.0, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.harmonizer2BPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 616.5, 320.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.harmonizer2BPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.harmonizer2BPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 46.0, 515.0, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 542.0, 45.0, 45.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 138.5, 504.0, 80.5, 504.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.5, 640.664551, 334.5, 640.664551, 334.5, 234.293396, 354.5, 234.293396 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"name" : "yk.pattr.harmonizer2BPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/harmonizer2/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "yk.harmonizer2BP.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/harmonizer2",
				"patcherrelativepath" : "..",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.harmonizer2.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/harmonizer2/lib",
				"patcherrelativepath" : "../lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.vdelay.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/lib/utillities/vdelay",
				"patcherrelativepath" : "../../../../lib/utillities/vdelay",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.pfft.harmonizer2.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/harmonizer2/lib",
				"patcherrelativepath" : "../lib",
				"type" : "JSON",
				"implicit" : 1
