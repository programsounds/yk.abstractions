...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"maxclass" : "bpatcher",
					"name" : "yk.tremoloBP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -7.633973, -8.04904 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 38.0, 506.160278, 186.049042, 143.660263 ],
					"varname" : "yk.tremoloBP"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -35.0, -20.0 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 38.0, 240.160263, 208.0, 259.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 23.761841, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.0, 240.160263, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.combMultiBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.0, 619.660278, 310.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.combMultiBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.combMultiBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 38.0, 659.160278, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 684.660278, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 387.5, 645.824829, 360.5, 645.824829, 360.5, 230.453659, 387.5, 230.453659 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-6::obj-32" : [ "live.gain~[7]", "live.gain~", 0 ]
		}
,
		"dependency_cache" : [ 			{
...
, 			{
				"name" : "yk.pattr.combMultiBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/combMulti/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "yk.tremoloBP.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/tremolo",
				"patcherrelativepath" : "../../tremolo",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../tremolo/lib",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
