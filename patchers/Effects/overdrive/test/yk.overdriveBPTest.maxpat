...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "yk.overdrive2chBP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -12.0, -15.128948 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 34.0, 243.5, 181.871048, 164.578964 ],
					"varname" : "yk.overdrive2chBP"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 34.0, 23.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 243.5, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.overdriveBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 623.0, 305.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.overdriveBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.overdriveBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 34.0, 426.222473, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 451.722473, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 416.5, 652.164551, 389.5, 652.164551, 389.5, 233.793396, 416.5, 233.793396 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"name" : "yk.pattr.overdriveBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/overdrive/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "yk.overdrive2chBP.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/overdrive",
				"patcherrelativepath" : "..",
				"type" : "JSON",
				"implicit" : 1
			}
