...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 430.0, 197.0, 201.0 ],
					"varname" : "yk.reverbBP"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 51.0, 243.0, 203.951309, 181.30658 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 22.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 243.0, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.resonatorBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 622.5, 307.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.resonatorBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.resonatorBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 51.0, 640.5, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 672.5, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 471.5, 650.664551, 444.5, 650.664551, 444.5, 233.293381, 471.5, 233.293381 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-5::obj-32" : [ "live.gain~[7]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.resonatorBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/resonator/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "yk.reverbBP.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/reverb",
				"patcherrelativepath" : "../../reverb",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "yk.poly.reverb.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/reverb/lib",
				"patcherrelativepath" : "../../reverb/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/lib/utillities/fadeGate",
				"patcherrelativepath" : "../../../../lib/utillities/fadeGate",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
