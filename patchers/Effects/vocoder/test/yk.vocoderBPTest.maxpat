...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					"name" : "yk.vocoder2chBP.maxpat",
					"numinlets" : 4,
					"numoutlets" : 3,
					"offset" : [ -4.0, -19.0 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 53.0, 251.0, 194.0, 262.0 ],
					"varname" : "yk.vocoder2chBP"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 30.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 421.0, 251.0, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.vocoderBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 421.0, 630.5, 300.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.vocoderBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.vocoderBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 53.0, 530.0, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 430.5, 658.664551, 403.5, 658.664551, 403.5, 241.293396, 430.5, 241.293396 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-61" : [ "live.gain~[2]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.vocoderBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/vocoder/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
