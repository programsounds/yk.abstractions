...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ -22.0, -13.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 797.0, 493.0, 238.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 530.0, 296.0, 258.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "yk.delay162x8chBP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 9,
					"offset" : [ -26.0, -17.0 ],
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 40.0, 243.140503, 204.515793, 278.435516 ],
					"varname" : "yk.delay162x8chBP"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 18.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 1.0, 2.0 ],
					"outlettype" : [ "", "", "", "int" ],
					"patching_rect" : [ 544.0, 84.238159, 377.0, 65.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 243.140503, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.delay162x8chBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 621.5, 326.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.delay162x8chBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.delay162x8chBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 544.0, 156.604187, 137.901917, 57.633972 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 553.5, 648.664551, 526.5, 648.664551, 526.5, 234.293381, 553.5, 234.293381 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 92.840073, 226.689331, 142.257904, 226.689331 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 672.401917, 226.689331, 142.257904, 226.689331 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 553.5, 226.689331, 49.5, 226.689331 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-132" : [ "live.gain~[9]", "live.gain~", 0 ],
			...
			"obj-6::obj-242" : [ "live.gain~[11]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.delay162x8chBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/delay16/2x8ch/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "yk.delay162x8chBP.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/delay16/2x8ch",
				"patcherrelativepath" : "..",
				"type" : "JSON",
				"implicit" : 1
			}
