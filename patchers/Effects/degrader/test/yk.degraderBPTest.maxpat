...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					"name" : "yk.degrader2chBP.maxpat",
					"numinlets" : 3,
					"numoutlets" : 3,
					"offset" : [ -11.0, -16.539474 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 43.0, 247.0, 186.0, 145.039474 ],
					"varname" : "yk.degraderBP"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 43.0, 27.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 247.0, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.degraderBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 626.5, 304.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.degraderBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.degraderBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 43.0, 401.0, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 426.5, 45.0, 45.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 372.5, 654.664551, 345.5, 654.664551, 345.5, 237.293381, 372.5, 237.293381 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-4::obj-32" : [ "live.gain~[11]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.degraderBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/degrader/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "yk.degrader2chBP.maxpat",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/degrader",
				"patcherrelativepath" : "..",
				"type" : "JSON",
				"implicit" : 1
			}
