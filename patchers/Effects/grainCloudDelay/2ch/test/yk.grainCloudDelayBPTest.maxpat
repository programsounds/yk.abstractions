...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 238.0, 256.0, 223.924667 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 238.0, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.grainCloudDelayBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 617.5, 338.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.grainCloudDelayBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.grainCloudDelayBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 42.0, 478.0, 69.0, 18.0 ],
					"text" : "yk.peakLim 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 510.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 425.5, 645.664551, 398.5, 645.664551, 398.5, 229.293396, 425.5, 229.293396 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-13" : [ "live.gain~[2]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.grainCloudDelayBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/grainCloudDelay/2ch/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
