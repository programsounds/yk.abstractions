...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ -22.0, -13.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 759.859436, 493.0, 238.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 17.0, 495.740784, 196.238159 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 234.0, 256.0, 245.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -8.0, -2.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 234.0, 275.0, 371.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.grainCloudDelay8chBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.0, 612.359497, 354.0, 18.0 ],
...
,
					"text" : "pattrstorage yk.pattr.grainCloudDelay8chBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.grainCloudDelay8chBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -6.0, -4.0 ],
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 42.0, 487.859497, 303.0, 263.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 471.5, 639.524048, 444.5, 639.524048, 444.5, 225.152924, 471.5, 225.152924 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-3::obj-477" : [ "live.gain~[7]", "live.gain~", 0 ],
			"obj-9::obj-242" : [ "live.gain~[10]", "live.gain~", 0 ],
			...
			"obj-3::obj-375" : [ "live.gain~[5]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.grainCloudDelay8chBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Effects/grainCloudDelay/8ch/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
