...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 9,
					"numoutlets" : 1,
					"offset" : [ -8.956522166728973, -8.652174055576324 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.877865076065063, 768.702343225479126, 520.434765547513962, 253.043469965457916 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 12,
					"offset" : [ -7.900596809335709, -6.801192618671418 ],
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "bang", "int", "float", "" ],
					"patching_rect" : [ 36.0, 31.0, 561.832099914550781, 309.923685550689697 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 17,
					"numoutlets" : 9,
					"offset" : [ -6.515679359436035, -4.909407615661621 ],
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 35.877865076065063, 394.656515836715698, 361.290325164794922, 345.161292791366577 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.801557540893555, 368.70231556892395, 101.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ -8.896861016750336, -6.035874575376511 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 703.0, 320.0, 330.493284672498703, 487.443962603807449 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.0, 819.0, 389.0, 25.0 ],
...
,
					"text" : "pattrstorage yk.pattr.spatializerBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.spatializerBPTest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.801557540893555, 394.656515836715698, 118.48739629983902, 156.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 712.5, 862.787400762439802, 680.147865284839554, 862.787400762439802, 680.147865284839554, 304.044341746898681, 712.5, 304.044341746898681 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 455.301557540893555, 570.9791379570961, 424.667484511295243, 570.9791379570961, 424.667484511295243, 378.991277456283569, 387.668190240859985, 378.991277456283569 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-103" : [ "live.slider[11]", "live.slider[9]", 0 ],
			"obj-1::obj-110" : [ "live.slider[10]", "live.slider[9]", 0 ],
			"obj-1::obj-22" : [ "live.slider[17]", "live.slider[9]", 0 ],
			"obj-1::obj-33" : [ "live.slider[16]", "live.slider[9]", 0 ],
			"obj-1::obj-41" : [ "live.slider[15]", "live.slider[9]", 0 ],
			"obj-1::obj-65" : [ "live.slider[14]", "live.slider[9]", 0 ],
			"obj-1::obj-76" : [ "live.slider[13]", "live.slider[9]", 0 ],
			"obj-1::obj-85" : [ "live.slider[12]", "live.slider[9]", 0 ],
			"obj-1::obj-88" : [ "live.text[16]", "live.text", 0 ],
			"obj-1::obj-91" : [ "live.text[15]", "live.text", 0 ],
			"obj-1::obj-92" : [ "live.text[14]", "live.text", 0 ],
			"obj-1::obj-93" : [ "live.text[13]", "live.text", 0 ],
			"obj-1::obj-94" : [ "live.text[12]", "live.text", 0 ],
			"obj-1::obj-95" : [ "live.text[11]", "live.text", 0 ],
			"obj-1::obj-96" : [ "live.text[10]", "live.text", 0 ],
			"obj-1::obj-97" : [ "live.text[9]", "live.text", 0 ],
			"obj-2::obj-132" : [ "live.gain~[8]", "live.gain~", 0 ],
			"obj-2::obj-375" : [ "live.gain~[7]", "live.gain~", 0 ],
...
, 			{
				"name" : "yk.pattr.spatializerBPTest.json",
				"bootpath" : "~/Dev/Max/yk.abstractions/patchers/IO/spatializer/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
