...
, 			{
				"box" : 				{
					...
					"restore" : [ 1, 0, 3, 0, 0, 0, 1025.581421, 1.0, 3.851852 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"setfilter" : [ 0, 3, 0, 0, 0, 1025.581421, 1.0, 3.851852, 0.0001, 22050.0, 0.0001, 16.0, 0.5, 25.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.spectralSpreadBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 993.0, 629.5, 332.0, 18.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage yk.pattr.spectralSpreadBPTest @changemode 1 @greedy 1",
					"varname" : "yk.pattr.spectralSpreadBPTest"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "yk.pattr.spectralSpreadBPTest.json",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Sensors/spectralSpread/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
