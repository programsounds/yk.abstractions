...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.spectralSlopeBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 993.0, 629.5, 325.0, 18.0 ],
					"saved_object_attributes" : 					{
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Sensors/spectralSlope/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
