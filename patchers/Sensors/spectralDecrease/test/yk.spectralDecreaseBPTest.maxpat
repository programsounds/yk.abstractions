...
, 			{
				"box" : 				{
					...
					"restore" : [ 1, 0, 3, 0, 0, 0, 1098.837158, 1.0, 1.69697 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"setfilter" : [ 0, 3, 0, 0, 0, 1098.837158, 1.0, 1.69697, 0.0001, 22050.0, 0.0001, 16.0, 0.5, 25.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "yk.pattr.spectralDecreaseBPTest.json",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 993.0, 629.5, 342.0, 18.0 ],
					"saved_object_attributes" : 					{
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/Modules/Sensors/spectralDecrease/test",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
