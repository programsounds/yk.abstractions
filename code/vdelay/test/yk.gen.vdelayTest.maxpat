...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 216.0, 200.0, 56.0, 18.0 ],
					"sig" : 2.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 141.0, 173.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 141.0, 200.0, 67.0, 18.0 ],
					"text" : "mstosamps~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 38.0, 264.0, 103.0, 18.0 ],
					"text" : "yk.mix 0.5 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 310.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 38.0, 49.0, 225.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 66.0, 229.0, 169.0, 18.0 ],
					"text" : "gen~ yk.gen.vdelay"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 47.5, 215.0, 75.5, 215.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "yk.gen.vdelay.gendsp",
				"bootpath" : "/Users/yota/Data/Music/Software/Max/Patches/MyPatches/yk.abstractions/lib/gen/vdelay",
				"patcherrelativepath" : "..",
				"type" : "gDSP",
				"implicit" : 1
			}
